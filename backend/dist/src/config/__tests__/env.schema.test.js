...
describe('Environment Schema Validation', () => {
    ...
    it('passes validation when all required env vars are present and valid', () => {
        ...
        const { error, value } = env_schema_1.envSchema.validate(process.env, { abortEarly: false });
    ...
    it('fails validation if PORT is not a number', () => {
        ...
        const { error } = env_schema_1.envSchema.validate(process.env, { abortEarly: false });
